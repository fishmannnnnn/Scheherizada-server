...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "tariff_plans".
 */
export interface TariffPlan {
  id: string;
  name: 'free' | 'basic' | 'standard' | 'plus' | 'ultra';
  prices: {
    standardUserPrice: number;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "tariff_plans_select".
 */
export interface TariffPlansSelect<T extends boolean = true> {
  name?: T;
  prices?:
    | T
    | {
